...
const LeadSchema = new Schema(
    {
        ...
        called: { type: Boolean, default: false, description: 'Qo‘ng‘iroq qilindimi? (Operator1 true/false)' },
        callTime: { type: Date, description: 'Qo‘ng‘iroq vaqti(Operator1 ozgarmaydi faqat view)' },
        answered: { type: Boolean, default: false, description: 'Javob berildimi? (Operator1 true/false ozgaradi)' },
        callCount: { type: Number, default: 0, description: 'Qo‘ng‘iroqlar soni (Operator1 ozgaradi )' },
        interested: { type: Boolean, default: false, description: 'Qiziqish bildirildimi? (Operator1 true/false ozgaradi)' },
        ...
        status: {type: String, description:"Status" , enum: ['Archived', 'Closed']},
    },
        { timestamps: true }
);
